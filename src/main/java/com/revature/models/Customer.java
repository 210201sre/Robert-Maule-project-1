...
public Customer(int id,Date dateJoined, String firstname,String lastname, String zipcode, String city, String streetAdress, String state) {
	super();
	this.id=id;
...
public String toString() {
	return "Customer [dateJoined=" + dateJoined + ", id=" + id + ", firstName=" + firstName + ", lastName=" + lastName
			+ ", zipcode=" + zipcode + ", city=" + city + ", streetAdress=" + streetAdress + ", state=" + state + "]";
}

...
public class AccountController {
	...
	public ResponseEntity<CheckingsAccount> insert(@Valid @RequestBody CheckingsAccount cA,@PathVariable("id") int id ) {
	...
	public ResponseEntity<Set<Account>> transfer(@PathVariable("id1") int id1,@PathVariable("id2") int id2 ,@PathVariable("amount") double amount ) {
